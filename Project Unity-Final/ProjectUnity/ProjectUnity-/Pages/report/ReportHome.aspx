...
<ul class="nav navbar-nav navbar-right" runat="server" id="managenav">
       ...
       <li class="nav-item">
            ...
            <asp:DropDownList ID="ddlReportView" runat="server" Height="30px" Width="183px">
            </asp:DropDownList>

                 <br />

            <asp:DetailsView ID="dvReportPage" runat="server" Height="50px" Width="190px" HorizontalAlign="Center">
            </asp:DetailsView>
