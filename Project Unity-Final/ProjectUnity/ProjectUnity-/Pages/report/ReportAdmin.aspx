<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportAdmin.aspx.cs" Inherits="ProjectUnity_.Pages.report.ReportAdim" %>
...
<ul class="nav navbar-nav navbar-right" runat="server" id="managenav">
       ...
       <li class="nav-item">
            <asp:LinkButton ID="BtnLogout" runat="server" class="nav-link" OnClick="BtnLogout_Click">Log Out</asp:LinkButton>
              ...
              </nav>     <asp:Panel ID="Content" runat="server" Visible="False">        <div class="container">
            <h1>Admin Reports</h1>
