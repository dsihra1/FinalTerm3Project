     ...
     <asp:Panel ID="Content" runat="server" Visible="False">
        <div class="container">
            ...
            <table class="auto-style2">
                <tr>
                    <td>
                        <asp:Label ID="lblclientselect" runat="server" Text="Select Client"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlClientlist" runat="server" DataSourceID="dsclientlist" DataTextField="cliName" DataValueField="ID" Width="250px">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="lblSales" runat="server" ForeColor="#000000" Text="Sales Person:"></asp:Label>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddSales" runat="server" AutoPostBack="True" CssClass="txtbox" DataSourceID="dsSalesPerson">
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:ObjectDataSource ID="dsclientlist" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="ProjectUnity.NBD_SBDataSetTableAdapters.CLIENT1TableAdapter"></asp:ObjectDataSource>
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:ObjectDataSource ID="dsClientFilter" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="GetData" TypeName="ProjectUnity.NBD_SBDataSetTableAdapters.ClientFilterTableAdapter">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="ddlClientlist" Name="Param2" PropertyName="SelectedValue" Type="Int32" />
                            </SelectParameters>
