<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProdPlan-Edit.aspx.cs" Inherits="ProjectUnity_.Pages.production.ProdPlan_Edit" %>
...
<td>
            ...
            <asp:Label ID="lblProdTeam" runat="server" Text="Production"></asp:Label>
                    ...
                    <td>
            <asp:CheckBoxList ID="ddlProdTeam" runat="server" AutoPostBack="True" Width="166px">
            </asp:CheckBoxList>
                    </td>
                </tr>
            </table>
