<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bid Process-Delete.aspx.cs" Inherits="ProjectUnity_.Bid_Process_Delete" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <div class="container">
            <asp:Label ID="lblBidDelete" runat="server" Text="Select a Client For Whom you would like to delete  a Bid" style="margin:auto 40px 40px auto;"></asp:Label>
            ...
            <asp:Button ID="btnDeleteBid" runat="server" Text="Delete" CssClass="bigButton"/>
            <asp:Button ID="btnCancelBidDelete" runat="server" Text="Cancel" CssClass="bigButton"/>
        </div>
    </form>
</body>
</html>
